...
football_data <- football_data %>% 
  mutate(
    original_RPS = (ifelse(odds_type == FTR, 1, 0) - 1/original_odds)^2, 
    ratio_RPS = (ifelse(odds_type == FTR, 1, 0) - 1/ratio_odds)^2, 
    proportional_RPS = (ifelse(odds_type == FTR, 1, 0) - 1/proportional_odds)^2
  )
